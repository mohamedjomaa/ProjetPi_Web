 ...
 */
final class Version20220223080148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation DROP prenom, DROP nom, CHANGE type type VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation ADD prenom VARCHAR(255) DEFAULT NULL, ADD nom VARCHAR(255) NOT NULL, CHANGE type type VARCHAR(255) DEFAULT NULL');
    }
}
